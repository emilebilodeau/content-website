        ...
        <section className="py-20 bg-[#1a1d3a]">
          <div className="container">
            <div className="grid grid--2-col items-center gap-12">
              <div>
                <h2 className="font-bold text-white mb-6">Our Mission</h2>
              ...
              <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-12 text-white text-center">
                <div className="font-bold mb-4">100%</div>
        ...
        <section className="py-20 bg-[#080a20]">
          <div className="container">
            ...
            <div className="grid grid--3-col gap-8">
              <div className="text-center p-8 bg-[#1a1d3a] rounded-2xl shadow-lg border border-[#2a2d4a]">
                ...
                <h3 className="font-semibold text-white mb-4">Quality First</h3>
          ...
          <div className="container">
            ...
            <div className="grid grid--3-col gap-8">
              <div className="text-center">
                <div className="w-32 h-32 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white text-3xl font-bold mx-auto mb-4">
                  SJ
                </div>
                <h3 className="font-semibold text-white mb-2">Sarah Johnson</h3>
                <p className="text-blue-400 mb-2">Founder & Flavour Director</p>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-white mb-2">Michael Chen</h3>
                <p className="text-blue-400 mb-2">Production Manager</p>
                <p className="text-gray-300 text-sm">
              ...
              <div className="text-center">
                ...
                <p className="text-blue-400 mb-2">Flavour Development</p>
                <p className="text-gray-300 text-sm">
          ...
          <div className="container">
            ...
            <div className="grid grid--4-col gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-white mb-2">Craft</h3>
                <p className="text-gray-300 text-sm">
